...
from apps.productos.views import ViewProducto,categorias,nuevoRegistro, editarRegistro, eliminarRegistro, nuevoRegistroCat, editarRegistroCat, eliminarRegistroCat
